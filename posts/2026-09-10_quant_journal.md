...
- 📌 **통합 순자산 (Total NAV)**: **₩3,145,296** ($2,342.76) | 금일 손익: `₩-5,504 (-0.17%)`
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **통합 순자산 (Total NAV)** | **₩3,145,296** | **$2,342.76** | **₩-5,504** | **-5.08%** | 🟢 정상 (3대 봇 가동) |
| 봇: Bybit 메인 | ₩1,078,198 | $803.09 | $-4.10 | -3.33% | 🟢 정상 가동 |
| 봇: Bybit 서브 | ₩906,697 | $675.35 | $0.00 | -4.65% | 🟢 정상 가동 |
| 봇: Alpaca 미국주식 | ₩1,160,401 | $864.32 | $0.00 | -6.97% | 🟢 정상 가동 |

---

## 🪙 3. 가상자산(코인) 퀀트 운용 분석 (Bybit 메인 & 서브)
현재 가상자산 전체 평가 자산은 **$1,478.44 (₩1,984,894 원)**으로 전체 자산의 **63.1%**를 차지하고 있습니다.

### 🔍 실시간 오픈 포지션 내역
| 심볼 | 방향/레버리지 | 진입가 | 현재가 | 수익률(PnL) | 적용 전략 |
| :--- | :---: | :---: | :---: | :---: | :--- |
| **BNB/USDT** | `LONG 2x` | $766.4000 | $716.7000 | **-6.48%** | 능동형 동적 이격도 (Dynamic Disparity) |
| **ADA/USDT** | `LONG 2x` | $0.1941 | $0.2120 | **+9.22%** | 능동형 동적 이격도 (Dynamic Disparity) |
...
미국 주식 포트폴리오는 **$864.32 (₩1,160,401 원)** 규모로 전체의 **36.9%**를 구성하고 있습니다.
...
| **PLTR** | $186.87 | $169.05 | **-9.54%** | `51.75점` | NASDAQ-100 상위 모멘텀 |
