...
- 📌 **통합 순자산 (Total NAV)**: **₩3,126,174** ($2,326.84) | 금일 손익: `₩-6,221 (-0.20%)`
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **통합 순자산 (Total NAV)** | **₩3,126,174** | **$2,326.84** | **₩-6,221** | **-5.70%** | 🟢 정상 (3대 봇 가동) |
| 봇: Bybit 메인 | ₩1,073,166 | $798.77 | $-4.63 | -3.85% | 🟢 정상 가동 |
| 봇: Bybit 서브 | ₩902,812 | $671.97 | $0.00 | -5.13% | 🟢 정상 가동 |
| 봇: Alpaca 미국주식 | ₩1,150,196 | $856.10 | $0.00 | -7.79% | 🟢 정상 가동 |

---

## 🪙 3. 가상자산(코인) 퀀트 운용 분석 (Bybit 메인 & 서브)
현재 가상자산 전체 평가 자산은 **$1,470.74 (₩1,975,978 원)**으로 전체 자산의 **63.2%**를 차지하고 있습니다.

### 🔍 실시간 오픈 포지션 내역
| 심볼 | 방향/레버리지 | 진입가 | 현재가 | 수익률(PnL) | 적용 전략 |
| :--- | :---: | :---: | :---: | :---: | :--- |
| **BNB/USDT** | `LONG 2x` | $766.4000 | $715.1000 | **-6.69%** | 능동형 동적 이격도 (Dynamic Disparity) |
| **ADA/USDT** | `LONG 2x` | $0.1941 | $0.2114 | **+8.91%** | 능동형 동적 이격도 (Dynamic Disparity) |
...
미국 주식 포트폴리오는 **$856.10 (₩1,150,196 원)** 규모로 전체의 **36.8%**를 구성하고 있습니다.

### 🔍 주식 보유 종목 및 팩터 스코어
| 티커 (Ticker) | 평균 매수가 | 현재가 | 평가 손익률 | 모멘텀 점수 | 전략 팩터 |
| :--- | :---: | :---: | :---: | :---: | :--- |
| **SNOW** | $316.04 | $328.91 | **+4.07%** | `100.0점` | NASDAQ-100 상위 모멘텀 |
| **U** | $44.23 | $41.75 | **-5.62%** | `63.0점` | NASDAQ-100 상위 모멘텀 |
| **PLTR** | $186.87 | $167.20 | **-10.52%** | `51.75점` | NASDAQ-100 상위 모멘텀 |
...
- **적용 환율 (USD/KRW)**: **₩1,343.53** (🔥 [수수료 0원] 크로스 봇 내부 달러 직이체 최적 경로 권고)
- **크로스 봇 리밸런싱 가이드**: 환율이 중립 밴드(₩1,343.5)이므로, 환전 없이 봇 간 달러 직이체로 수수료 ₩3,184을 전액 절감하세요.
