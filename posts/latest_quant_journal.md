...
- 📌 **통합 순자산 (Total NAV)**: **₩3,143,913** ($2,341.73) | 금일 손익: `₩-5,491 (-0.17%)`
- 🪙 **가상자산 포트폴리오**: 비중 **63.1%** (Bybit 메인 & 서브) - ADA/USDT 안정 순항 및 동적 이격도 알고리즘 방어
- 🇺🇸 **미국 주식 포트폴리오**: 비중 **36.9%** (Alpaca 마켓) - 나스닥-100 상위 모멘텀 3종목 분산 및 환율 안정 밴드
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **통합 순자산 (Total NAV)** | **₩3,143,913** | **$2,341.73** | **₩-5,491** | **-5.12%** | 🟢 정상 (3대 봇 가동) |
| 봇: Bybit 메인 | ₩1,077,965 | $802.92 | $-4.09 | -3.35% | 🟢 정상 가동 |
| 봇: Bybit 서브 | ₩906,406 | $675.13 | $0.00 | -4.68% | 🟢 정상 가동 |
| 봇: Alpaca 미국주식 | ₩1,159,542 | $863.68 | $0.00 | -7.04% | 🟢 정상 가동 |

---

## 🪙 3. 가상자산(코인) 퀀트 운용 분석 (Bybit 메인 & 서브)
현재 가상자산 전체 평가 자산은 **$1,478.05 (₩1,984,371 원)**으로 전체 자산의 **63.1%**를 차지하고 있습니다.

### 🔍 실시간 오픈 포지션 내역
| 심볼 | 방향/레버리지 | 진입가 | 현재가 | 수익률(PnL) | 적용 전략 |
| :--- | :---: | :---: | :---: | :---: | :--- |
| **BNB/USDT** | `LONG 2x` | $766.4000 | $717.1000 | **-6.43%** | 능동형 동적 이격도 (Dynamic Disparity) |
| **ADA/USDT** | `LONG 2x` | $0.1941 | $0.2118 | **+9.12%** | 능동형 동적 이격도 (Dynamic Disparity) |
...
미국 주식 포트폴리오는 **$863.68 (₩1,159,542 원)** 규모로 전체의 **36.9%**를 구성하고 있습니다.

### 🔍 주식 보유 종목 및 팩터 스코어
| 티커 (Ticker) | 평균 매수가 | 현재가 | 평가 손익률 | 모멘텀 점수 | 전략 팩터 |
| :--- | :---: | :---: | :---: | :---: | :--- |
| **SNOW** | $316.04 | $331.55 | **+4.91%** | `100.0점` | NASDAQ-100 상위 모멘텀 |
| **U** | $44.23 | $42.17 | **-4.67%** | `63.0점` | NASDAQ-100 상위 모멘텀 |
| **PLTR** | $186.87 | $168.64 | **-9.76%** | `51.75점` | NASDAQ-100 상위 모멘텀 |
...
- **크로스 봇 리밸런싱 가이드**: 환율이 중립 밴드(₩1,342.6)이므로, 환전 없이 봇 간 달러 직이체로 수수료 ₩3,249을 전액 절감하세요.
